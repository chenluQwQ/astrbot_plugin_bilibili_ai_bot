"""
AstrBot Plugin - Bilibili Bot 1.5.1
...
@register("astrbot_plugin_bilibili_ai_bot","chenluQwQ","B站 AI Bot — 自动回复评论、好感度、记忆、心情、用户画像、主动视频、动态发布、LLM工具调用","1.5.1","https://github.com/chenluQwQ/astrbot_plugin_bilibili_ai_bot")
